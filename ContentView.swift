...
import UniformTypeIdentifiers
	...
	struct ContentView: View {
        ...
        @State private var handwritingRefinementEnabled = false
    ...
    var body: some View {
        ZStack(alignment: .bottomTrailing) {
            ...
            .onChange(of: metalViewCoordinator) { _, newCoord in
                ...
                newCoord?.handwritingRefinementEnabled = handwritingRefinementEnabled
                    ...
                    VStack(alignment: .trailing, spacing: 12) {
                        HStack(spacing: 12) {
	                        ...
	                        HStack(spacing: 12) {
	                            ...
	                            Button(action: {
                                    handwritingRefinementEnabled.toggle()
                                    coordinator.handwritingRefinementEnabled = handwritingRefinementEnabled
                                }) {
	                                VStack(spacing: 2) {
	                                ...
	                                .foregroundColor(handwritingRefinementEnabled ? .purple : .white)
	                                .padding(8)
	                                .background(.ultraThinMaterial)
	                                .cornerRadius(12)
	                            }
